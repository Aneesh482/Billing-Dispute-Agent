...
"[project]/src/components/Toaster.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Toaster() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Toaster"], {
        ...
        fileName: "[project]/src/components/Toaster.tsx",
        lineNumber: 7,
        columnNumber: 5
    }, this);
}
...
const api = {
    ...
    disputes: {
        list: (params)=>{
            ...
            return apiFetch(`/api/disputes${qs}`);
        },
        get: (id)=>apiFetch(`/api/disputes/${id}`),
        create: (data)=>apiFetch("/api/disputes", {
                method: "POST",
                body: JSON.stringify(data)
            }),
        update: (id, data)=>apiFetch(`/api/disputes/${id}`, {
                method: "PATCH",
                body: JSON.stringify(data)
            }),
        generateEmail: (id)=>apiFetch(`/api/disputes/${id}/generate-email`, {
                method: "POST"
            }),
        sendEmail: (id, email)=>apiFetch(`/api/disputes/${id}/send-email`, {
                method: "POST",
                body: JSON.stringify(email ?? {})
            }),
        getEmails: (id)=>apiFetch(`/api/disputes/${id}/emails`),
        getPendingDraft: (id)=>apiFetch(`/api/disputes/${id}/pending-draft`),
        approveSend: (id, edited)=>apiFetch(`/api/disputes/${id}/approve-send`, {
                method: "POST",
                body: JSON.stringify(edited ?? {})
            }),
        skip: (id)=>apiFetch(`/api/disputes/${id}/skip`, {
                method: "POST"
            })
    },
    settings: {
        update: (data)=>apiFetch("/api/users/me/settings", {
                method: "PATCH",
                body: JSON.stringify(data)
            }),
        updateApprovalMode: (mode)=>apiFetch("/api/users/me/settings", {
                method: "PATCH",
                body: JSON.stringify({
                    approval_mode: mode
                })
            }),
        validateSheet: (spreadsheetId)=>apiFetch(`/api/sheets/validate?spreadsheet_id=${encodeURIComponent(spreadsheetId)}`)
    }
};
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
...
function AuthProvider({ children }) {
    ...
    const fetchUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[fetchUser]": async ()=>{
            try {
                const u = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].auth.me();
                setUser(u);
            } catch  {
                setUser(null);
            } finally{
    ...
    const logout = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[logout]": async ()=>{
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].auth.logout();
            } catch  {
...
_s(AuthProvider, "OLtEvTfEXFvfyPIzTlusyqIJnH4=", false, function() {
    return [
...
//# sourceMappingURL=src_00qvx9o._.js.map